...
public class CalcTest {
    ...
    @Test
    @DisplayName("10 * 20 + 10 + 5 * 2 - 2 * 15 * 2 = 160")
    public void test13() {
        assertThat(Calc.run("10 * 20 + 10 + 5 * 2 - 2 * 15 * 2")).isEqualTo(160);
    }
    ...
    @Test
    @DisplayName("(10 + 20) + (15 * 2) * 2 = 90")
    public void test18() {
        assertThat(Calc.run("(10 + 20) + (15 * 2) * 2")).isEqualTo(90);
    }
